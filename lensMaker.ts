...
export type LensMaker<T> = {
    ...
    withPath<
        ...
        >(
            ...
            p5: P5,
            p6: P6
        ): SimpleLens<T, T[P1][P2][P3][P4][P5][P6]>;
    ...
    withPath<
        ...
        >(
            ...
            p6: P6,
            p7: P7
        ): SimpleLens<T, T[P1][P2][P3][P4][P5][P6][P7]>;
    ...
    withPath<
        ...
        >(
            ...
            p7: P7,
            p8: P8,
        ): SimpleLens<T, T[P1][P2][P3][P4][P5][P6][P7][P8]>;
    ...
    withPath<
        ...
        >(
            ...
            p8: P8,
            p9: P9,
        ): SimpleLens<T, T[P1][P2][P3][P4][P5][P6][P7][P8][P9]>;
};